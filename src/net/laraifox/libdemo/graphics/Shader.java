...
import net.laraifox.libdemo.utils.FileUtils;
...
public class Shader {
	...
	public Shader(String vertexFilepath, String fragmentFilepath, boolean bindAttributes) throws Exception {
		...
		this.id = this.createShader(vertexFilepath, fragmentFilepath, bindAttributes);
	}
	...
	private int createShader(String vertexFilepath, String fragmentFilepath, boolean bindAttributes) throws Exception {
		...
		int programLinkStatus = GL20.glGetProgrami(program, GL20.GL_LINK_STATUS);
		if (programLinkStatus == GL11.GL_FALSE) {
			String infoLog = GL20.glGetProgramInfoLog(fragmentShader, GL20.glGetProgrami(program, GL20.GL_INFO_LOG_LENGTH));
	...
	public void setUniform(String name, Matrix4f value) {
		GL20.glUniformMatrix4(uniforms.get(name), true, BufferUtil.createFlippedFloatBuffer(value));
	}
}
