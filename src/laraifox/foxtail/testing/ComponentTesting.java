...
import laraifox.foxtail.physics.PhysicsComponent;
import laraifox.foxtail.physics.PhysicsEngine;
...
public class ComponentTesting implements IGameManager {
	...
	public void initialize(OpenGLDisplay display) {
		...
		sphere1.addComponent(new PhysicsComponent(new Vector3f(1.0f, 0.0f, 0.0f), null));
