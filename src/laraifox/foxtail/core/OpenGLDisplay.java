...
public final class OpenGLDisplay {
	private static final String DEFAULT_TITLE = new String("OpenGL Display - Foxtail Game Engine");
	...
	private final void gameLoop() {
		...
		long nanosecondsPerTick = (long) ((float) MathUtils.MILLIARD / (float) tickrate);
		long nanosecondsPerUpdate = (long) ((float) MathUtils.MILLIARD / (float) updaterate);
